    ...
    >
      ...
      <div className="bg-white p-4 font-semibold flex flex-col border border-stone-300 rounded-b-lg">
        <div className="flex justify-between items-center">
          ...
          {
                  dog.sex === "Female" ? <i className="text-orange-400 w-4 fa-solid fa-venus"> </i> : <i className="text-sky-500 w-4 fa-solid fa-mars"></i>
                }
            <div className={dog.sex === "Female" ? "my-1 text-orange-400" : "my-1 text-sky-500"}>{dog.sex}</div>

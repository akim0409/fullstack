...
const runSeed = async () => {
  ...
  const bella = await alvinUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `They are initally wary and cautious around strangers, they takes a bit of time to warm up and establish trust. However, once they feel comfortable and safe, 
      their true affectionate nature shines through. They form deep bonds with their loved ones and become incredibly loyal and devoted companions.`,
    imageUrl:
  ...
  const cooper = await alvinUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `They seek tranquility and calmness, this dog finds solace in quiet environments. They appreciate a peaceful atmosphere that allows them to relax 
      and unwind. Loud noises or chaotic surroundings can make them feel anxious or overwhelmed, so they prefer serene surroundings that promote a sense of security.`,
    imageUrl:
  ...
  const milo = await alvinUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `The company of a single person or dog is what this dog truly relishes. They thrive in one-on-one interactions, where they can receive undivided attention 
      and build a strong emotional connection through playtime. Whether it's long walks, playtime, or just cuddling on the couch, they value the intimacy and focused interaction of a personal bond and a new friend.`,
    imageUrl:
  ...
  const coco = await alvinUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `Once they've established trust, they become incredibly loyal and attached to their dog friends. They are always by their side, eagerly participating
      in activities and providing an unwavering playmate. Their friendliness and joy for play knows no bounds, and they will go to great lengths to protect and support their friends.`,
    imageUrl:
  ...
  const tucker = await autumnUser.createDog({
    ...
    favoriteTreat: "Bacon",
    personality:
      `The separation from their humans can be a challenging experience for this sensitive dog. When left alone, they may express their distress through vocalizations or
      behaviors such as whimpering or pacing. However, once they spend time with another dog; they are very friendly. They genuinely crave the presence of me and feel most secure when I am in close proximity.`,
  ...
  const oliver = await autumnUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `Beneath their initial wariness lies a gentle and affectionate nature. Once they feel secure, they open up and becomes a warm and loving playmate. They enjoy 
      physical closeness and rough play and will seek opportunities to snuggle up and share tender moments with their dog friends after playtime. They bark a lot.`,
    imageUrl:
  ...
  const daisy = await autumnUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `While they may initially be reserved around unfamiliar dogs or large groups, they can develop close friendships with compatible canine companions. Female dogs preferred.
      With the right introduction in a calm setting, they can thrive in the company of like-minded furry friends. They appreciate a select circle of trusted companions with whom they can play endless tug of war with.`,
    imageUrl:
  ...
  const otto = await autumnUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
    `Their friendliness and joy for play knows no bounds. They thrive in one-on-one interactions, where they can receive undivided attention 
    and build a strong emotional connection through playtime. Whether it's long walks, playtime, or just cuddling on the couch, 
    they value the intimacy and focused interaction of a personal bond and a new friend.`,
  ...
  const diamond = await donaldUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `They prefer to play with small dogs only and are intimidated by large breeds. They find comfort in familiar surroundings, so playdates will be at their usual parks.
      Loud noises and too many dogs or people can unsettle them, so they appreciate a stable and consistent environment that allows them to feel grounded and at ease.`,
    imageUrl:
  ...
  const leo = await juneUser.createDog({
    ...
    favoriteTreat: "Dental Treats",
    personality:
      `They possesses an acute awareness of their surroundings and are sometime anxious. They are highly observant and attuned to their environment. Some call my dog skittish, but he's just a little ancy.
      They love rough play, and are still gentle with smaller breed playmates.`,
    imageUrl:
  ...
  await testDate4.addGuest(daisy);
